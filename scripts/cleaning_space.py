...
if __name__ == '__main__':
    try:
        ...
        points_to_publish = [(-0.9168656468391418, 2.0721588134765625, 0), 
                                (3.7312662601470947, 1.9001405239105225, 0), 
                                (-0.622028648853302, 3.29244065284729, 0), 
                                (3.7280995845794678, 3.868736743927002, 0),
                                (3.666754722595215, 1.9620170593261719, 0),
                                (-0.9550445675849915, 2.0840022563934326, 0)]
        
        # Publish each point
        for point in points_to_publish:
            publish_point(point[0], point[1])
